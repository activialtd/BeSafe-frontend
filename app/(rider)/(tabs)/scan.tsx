...
export default function ScanScreen() {
  ...
  const onScanned = useCallback((result: { data: string }) => {
    ...
    router.push({
      pathname: "/verify-ride",
      params: { mode: "qr", token: result.data },
    });
    setTimeout(() => {
    ...
    return (
      ...
      >
        <View style={{ alignItems: "center", marginTop: 40 }}>
          ...
          >
            BeSafe needs camera access to verify the vehicle you're about to
            enter.
          </Text>
        </View>
        ...
        <View style={{ marginTop: "auto", paddingBottom: 40, gap: 12 }}>
          ...
          <Button
            label="Enter plate number instead"
            variant="ghost"
            onPress={openManual}
          />
        </View>
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.overlay}>
        ...
        {/* bottom dim edge - increased flex to push the scanner up */}
        <View style={[styles.overlayEdge, { flex: 1.5 }]} />
      </View>
