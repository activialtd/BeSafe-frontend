...
export const mapStyleLight = [
  ...
  { featureType: 'road.highway', elementType: 'geometry', stylers: [{ color: '#FFECDF' }] },
...
export const mapStyleDark = [
  ...
  { elementType: 'labels.text.fill', stylers: [{ color: '#6B7280' }] },
  { featureType: 'administrative', elementType: 'geometry', stylers: [{ color: '#1A2233' }] },
  { featureType: 'road', elementType: 'geometry', stylers: [{ color: '#111827' }] },
  { featureType: 'road', elementType: 'geometry.stroke', stylers: [{ color: '#1F2937' }] },
  { featureType: 'road.highway', elementType: 'geometry', stylers: [{ color: '#232D42' }] },
  ...
  { featureType: 'poi', elementType: 'labels', stylers: [{ visibility: 'off' }] },
  { featureType: 'poi.park', elementType: 'geometry', stylers: [{ color: '#0F1521' }] },
  { featureType: 'transit', stylers: [{ visibility: 'off' }] },
];
